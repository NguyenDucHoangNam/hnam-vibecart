...
public enum ErrorCode {
    ...
    UNAUTHENTICATED(1006, "Xác thực thất bại. Vui lòng kiểm tra lại tài khoản hoặc mật khẩu", HttpStatus.UNAUTHORIZED),
    ...
    // IAM: OTP & Account Security (1011 - 1025)
    ...
    CANNOT_CHANGE_OWN_STATUS(1024, "Không thể thay đổi trạng thái tài khoản của chính mình", HttpStatus.BAD_REQUEST),
    INVALID_STATUS(1025, "Trạng thái tài khoản không hợp lệ", HttpStatus.BAD_REQUEST),
    CANNOT_CHANGE_OWN_ROLE(1026, "Không thể tự thay đổi vai trò (phân quyền) của chính mình", HttpStatus.BAD_REQUEST),
    RATE_LIMIT_EXCEEDED(1030, "Bạn đã gửi quá nhiều yêu cầu. Vui lòng thử lại sau", HttpStatus.TOO_MANY_REQUESTS),

    // E-Commerce: Product & Inventory (2001 - 2009)
    ...
    // E-Commerce: System & Payment (2050 - 2069)
