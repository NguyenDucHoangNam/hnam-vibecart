...
2.  Nếu **tồn tại** -> Ném ra lỗi `AppException(ErrorCode.ACCOUNT_TEMPORARILY_LOCKED)` (HTTP 423 Locked) với thông điệp: *"Tài khoản tạm thời bị khóa do nhập sai nhiều lần. Vui lòng thử lại sau 15 phút"*.
